...
export class AccountApi {
   ...
   */
  private get<P extends AccountGetPath>(
    path: P,
    parameters: AccountGetPathToParams[P]
  ): Promise<AccountGetPathToResponse[P]> {
  ...
  getTransactions({
    dateFrom,
    dateTo,
  }: AccountGetTransactionsParams = {}): Promise<RetrieveAccountTransactionsResponse> {
