...
import type {
  AgreementAcceptPraams as AgreementAcceptParams,
...
export class AgreementApi {
  ...
  getAgreements({
    limit = 100,
    offset = 0,
  }: RetrieveAllEuAsForAnEndUserParams = {}): Promise<RetrieveAllEuAsForAnEndUserData> {
  ...
  acceptAgreement({
    ...
    ip,
    userAgent,
  }: AgreementAcceptParams): Promise<AcceptEuaData> {
