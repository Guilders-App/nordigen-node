...
import type { DateFilter, WithClient } from "./client";
import type { OmitIdParam } from "./common";
...
export interface AccountPremiumGetTransactionsParams
  extends AccountGetTransactionsParams {
  country?: CountryEnum;
}
...
export interface AccountPremiumGetPathToResponse
  extends Record<AccountGetPath, {}> {
  transactions: RetrieveAccountTransactionsPremiumResponse;
}
export interface AccountPremiumGetPathToParams
  extends Record<AccountPremiumGetPath, {}> {
